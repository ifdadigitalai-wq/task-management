    ...
    <div style={{ padding: "32px" }}>
      <div style={{ marginBottom: "28px" }}>
        ...
        <p style={{ fontSize: "13px", color: timeTheme.mutedTextColor, marginTop: "4px", transition: "color 0.6s ease" }}>
          Browse and search all tasks across the organisation
        </p>
      </div>
